// #YOLO Vendored from the grafana repo(https://github.com/grafana/grafana/blob/main/pkg/components/simplejson/simplejson.go#L6) which was vendored from
// the unmaintained repo https://github.com/bitly/go-simplejson
// Only reason for using it is because it's already being used by the grafana server.
// TODO(dm): refactor
